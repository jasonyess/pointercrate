SELECT demons.id AS demon_id, demons.name::text AS demon_name, demons.position, demons.requirement, demons.level_id, demons.rated, CASE WHEN verifiers.link_banned THEN NULL ElSE demons.video::text END, demons.thumbnail,
...
WHERE (demons.id < $1 OR $1 IS NULL)
  AND (demons.id > $2 OR $2 IS NULL)
